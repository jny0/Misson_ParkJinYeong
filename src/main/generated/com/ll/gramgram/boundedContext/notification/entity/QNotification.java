...
public class QNotification extends EntityPathBase<Notification> {
    ...
    public final NumberPath<Integer> previousAttractiveTypeCode = createNumber("previousAttractiveTypeCode", Integer.class);

    public final StringPath previousGender = createString("previousGender");
