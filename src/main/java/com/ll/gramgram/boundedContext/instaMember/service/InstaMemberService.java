...
public class InstaMemberService {
    ...
    public RsData<InstaMember> connect(Member member, String username, String gender) {
        ...
        if (opInstaMember.isPresent() && !opInstaMember.get().getGender().equals("U")) {
            // 그러면 실패
            return RsData.of("F-1", "해당 인스타그램 계정은 이미 다른 사용자와 연결되었습니다.");
        }
    ...
    public void whenAfterModifyAttractiveType(LikeablePerson likeablePerson, int previousAttractiveTypeCode) {
        InstaMember fromInstaMember = likeablePerson.getFromInstaMember();
        InstaMember toInstaMember = likeablePerson.getToInstaMember();

        toInstaMember.decreaseLikesCount(fromInstaMember.getGender(), previousAttractiveTypeCode);
    ...
    public void whenAfterFromInstaMemberChangeGender(InstaMember instaMember, String previousGender) {
        instaMember
    ...
    public RsData<InstaMember> connect(Member actor, String gender, String oauthId, String username, String accessToken) {
        ...
        if (opInstaMember.isPresent()) {
            ...
            return RsData.of("S-3", "인스타 계정이 연결되었습니다.", instaMember);
        }
        ...
        if (opInstaMember.isPresent()) {
            ...
            return RsData.of("S-4", "인스타 계정이 연결되었습니다.", instaMember);
        }
        ...
        return RsData.of("S-5", "인스타 계정이 연결되었습니다.", instaMember);
    }
}
